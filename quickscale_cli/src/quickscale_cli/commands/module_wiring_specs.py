...
def _render_social_managed_views_module(
    ...
    return (
        ...
        "                DEFAULT_LINK_TREE_PATH,\n"
        "            ),\n"
        '            "layout_variant": str(\n'
        '                getattr(settings, "QUICKSCALE_SOCIAL_LAYOUT_VARIANT", "list")\n'
        "            ),\n"
        '            "links_per_page": _setting_int(\n'
        ...
        "        }\n"
        "    )\n"
        "    status_code = 200 if enabled else 404\n"
        ...
        "                DEFAULT_EMBEDS_PATH,\n"
        "            ),\n"
        '            "cache_ttl_seconds": _setting_int(\n'
        '                "QUICKSCALE_SOCIAL_CACHE_TTL_SECONDS",\n'
        "                300,\n"
        "            ),\n"
        '            "embeds_per_page": _setting_int(\n'
