...
2. Create a new release document in `docs/releases/release-v[VERSION]-implementation.md`
...
Reference examples:
- `docs/releases/release-v0.52.0-implementation.md` - Project Foundation
- `docs/releases/release-v0.53.1-implementation.md` - Core Django Templates
