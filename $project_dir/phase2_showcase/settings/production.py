"""
Production settings for phase2_showcase.
...
if not database_url:
    # Catches both None and empty string "" (e.g. unresolved Railway reference)
...
if "DEFAULT_FROM_EMAIL" not in globals():
    DEFAULT_FROM_EMAIL = config(
        "DEFAULT_FROM_EMAIL",
        default="noreply@phase2_showcase.com",
    )
if "SERVER_EMAIL" not in globals():
    SERVER_EMAIL = config(
        "SERVER_EMAIL",
        default="server@phase2_showcase.com",
    )
...
ADMINS = [
    ("Admin", config("ADMIN_EMAIL", default="admin@phase2_showcase.com")),
]
MANAGERS = ADMINS
