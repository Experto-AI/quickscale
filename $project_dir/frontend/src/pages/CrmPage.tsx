      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            API-backed CRM workspace for contacts, companies, deals, and pipeline. The Django
            dashboard at /crm/ remains staff-only.
          </p>
        </div>
