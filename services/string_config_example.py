"""
Usage example for StringConfigService.

This example demonstrates how to use the string_config service
...
def use_string_config_service(user, **kwargs):
    """Example function showing how to use the string_config service."""
    
    # Method 1: Using the service registry
    service = create_service_instance("string_config")
    if not service:
        return {'error': 'Service string_config not found'}
...
def example_usage():
    ...
    result = use_string_config_service(
        user,
