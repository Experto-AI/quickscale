...
- v0.85.0 — 2026-05-18 — Billing Module (release-prepared; maintainer tag/publish pending after green `make lint`, `make typecheck`, `make test`, `make version-check`, and `make ci-e2e` gates; billing now ships direct Stripe-backed credit purchases and subscriptions, planner/apply readiness, module-owned pricing and dashboard pages, and starter-theme billing links)
