...
**Example change**:
```diff
-1. Store themes in `quickscale_core/generator/templates/themes/{starter_html,starter_react}/`
+1. Store themes in `quickscale_core/generator/templates/themes/{showcase_html,showcase_react}/`
```
...
+# quickscale init myapp --theme showcase_html  # Default Showcase HTML theme
 # quickscale init myapp --theme showcase_react  # React theme
```
...
# Error message should suggest: Available themes: showcase_html, showcase_react
```
