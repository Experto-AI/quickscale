...
- End-to-end `quickscale plan` → `quickscale apply` → React public-page validation remains deferred to future workflow-validation work tracked in the [roadmap](../technical/roadmap.md).
