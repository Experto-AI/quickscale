...
- End-to-end `quickscale plan` → `quickscale apply` → React public-page validation remains deferred to [v0.87.0](../technical/roadmap.md#v0870-module-workflow-validation--real-world-testing).
