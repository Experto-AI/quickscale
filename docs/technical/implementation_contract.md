...
accepted on retained product object `91fd3bb6e6b638735361b511c1515cddccce5d15`, but F remains
...
SA164 remains after SA166.
The settled product bytes no longer carry CLI per-module
wiring logic. **`SA167d`**
