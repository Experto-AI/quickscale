...
- **Current in-repo milestone:** v0.83.0 hardening is published and archived; active forward roadmap work now begins at v0.84.0 billing
...
- v0.84.0 billing is now the next planned milestone.
