...
✓ TP suite closed             complete)                           (make check/quality/ci/ci-e2e)
  (TP1/TP2/TP2b/           SA106 ✓ ── identity de-spec (2b;       all four exit 0; empty quarantine
   TP3a/TP3b/TP4)             deps SA104 ✓; complete)                   │
                               │                                       ▼
