...
SA112a (provisioner) ◄─ next        SA115 (e2e xdist; deps: none) SA117e-1 → -2 → -3 → -4 → -5
  ...
  │  plan re-authorized (AUTH-006)    │  cannot finish → SA112f     │  review · source · infra ·
...
**No track-sequencing or worktree-assignment question is open.** Two implementation decisions are now recorded on SA117e-1 for clean continuation into SA117e-4: the explicit-absence Git lease contract for `SA117E1-REV-001`, and bind/consume versus approved de-advertise/defer disposition for `SA117E1-REV-002`. The earlier authorization decisions were resolved on 2026-08-01:
...
Track 1 remains startable; Track 3 is preserved at **SA117e-1**, whose historical review ran but whose documentation closeout remains open. Plan-review `F-002` blocks SA117e-3's host-service mutation pending that child's scoped plan-review `STATUS: ok`; `SA117E1-REV-001` and `SA117E1-REV-002` separately block SA117e-4's public split push. The push confirmation and later SA96-PUBLISH remain **execution-time** human gates, never standing authorization.
