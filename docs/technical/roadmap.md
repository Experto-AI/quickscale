...
TP4 ── AI fast-loop        SA105 ── module de-spec (2a;       SA96-GATE ── green-gate join
  recipes (docs-only)        deps SA104 ✓; decision resolved)    (make check/quality/ci/ci-e2e)
