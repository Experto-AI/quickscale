...
| **W3** | SA151 (#3, **in progress**) | **yes** — in flight; P1 merged, P2 committed on `wt-track3`, P3 plan written | **yes** — P2/P3 are W3-owned; the exclusive slot is held | **yes** — #3 is first in the queue | **truly green — off the critical path** (second chain) |
