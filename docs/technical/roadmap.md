...
> - **Track 3** — clean. SA75 (TA56 — narrow a test fixture's overly-broad exception catch) is completed in this change; no Track 3 items remain open. It stayed parallel-safe and unrelated to the SA67 beta-site closeout (whose outstanding manual check remains tracked in `beta-site-migration.md`, not here).
...
Track 3 is clean again after SA75's closeout. The completed item is kept below for immediate merge-closeout traceability; no Track 3 items remain open.
