...
> **Track status (2026-07-10, SA65–SA70 opened; SA63/SA69 closed same day):** Track 1 — **3 open items** (SA59, SA60, SA70) — **SA59 is blocked** on a maintainer decision (publish.yml's release-test DB posture); SA60/SA70 are clear to continue. Track 2 — **0 open items**, fully closed this pass. Track 3 — **4 open items** (SA65, SA66, SA67, SA68) — SA65/SA66/SA68 are clear to continue; SA67 needs manual verification against the external beta-site repos (`experto-ai-web`, `bap-web`), outside this monorepo.
