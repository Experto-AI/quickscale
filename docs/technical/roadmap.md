...
> **Closed batches (detail in [CHANGELOG.md](../../CHANGELOG.md)):** SA1–SA5 (2026-07-02), SA6–SA12 (2026-07-03), SA13.1–SA13.4 (2026-07-04), SA14.1–SA14.6 (2026-07-05), SA15.1–SA15.3 (2026-07-04), SA16.1/SA16.2 (2026-07-03), SA17.1–SA17.8 (2026-07-05), SA18.1–SA18.11 (2026-07-04), SA19 (2026-07-05), SA21.1 (2026-07-05), SA22 (2026-07-05), SA23 (2026-07-05), SA24 (2026-07-05), SA25 (2026-07-05), SA26 (2026-07-06), SA27 (2026-07-05), SA28 (2026-07-05), SA29 (2026-07-05), SA30 (2026-07-06), SA31 (2026-07-05), SA32 (2026-07-06), SA33 (2026-07-05). All closed per template rule — detail lives in CHANGELOG.md.

> **Track status (2026-07-06):** Track 1 clear: SA28, SA24, SA29, and SA30 complete (SA14, SA23 also complete — archived); no remaining Track 1 backlog in this phase set. Track 2: SA20 complete (CR-SA20-005 through CR-SA20-008, CR-SA20-REV-001, CR-SA20-REV-002 resolved); SA21.2 is ready. Track 3: SA26 complete (SA21.1, SA22, SA25, SA27, SA31, SA32, SA33 also closed) — all open Track 3 items closed. See track sections below for `why →` finding links.
...
SA30 — complete (no deps)                                                     SA26 — complete
```
...
- [x] **SA26 — Sanitize markdown-rendered URI schemes on public blog/listing pages.** `Tier 2 · Track 3 · deps: none`
  ...
  *Acceptance:* blog `test_post_detail_sanitizes_javascript_markdown_links`, `test_post_detail_preserves_https_markdown_links`, `test_post_detail_preserves_mailto_markdown_links` and listings `test_listing_detail_sanitizes_javascript_markdown_links`, `test_listing_detail_preserves_https_markdown_links`, `test_listing_detail_preserves_mailto_markdown_links` continue to pass; new tab-obfuscation, newline-obfuscation, case-variant, data-scheme, and vbscript-scheme neutralization tests also pass for both modules.
