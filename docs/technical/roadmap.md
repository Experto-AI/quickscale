...
All Phase 2 tasks (T1.5–T1.10) are mutually independent — no inter-worktree coordination needed. Phase 3 RLS tasks each require their Phase 2 counterpart **and** T1.4 (currently in progress). T1.17 waits for all Phase 2. See [Track 1 sequencing](#track-1-sequencing) below.
...
- [~] T1.4 — RLS DB role + generated-project settings *(in progress · wt-track1)*
