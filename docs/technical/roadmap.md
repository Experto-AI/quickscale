...
**No worktree-assignment question is open; the 2026-08-06 rebalancing review applied no move — the ninth consecutive pass to reach that conclusion — but it added the SA136 umbrella to Track 3.** Every open v87 ticket carries a track, Track 2 is closed to new work by standing rule (homing anything there drags SA115 onto `v87`), and SA112a — the one node previously worth parallelizing onto Track 1 — has closed and merged. The remaining off-path work (SA122b-3…5) is a single serial chain; moving any of it onto Track 3 would push filler ahead of the critical path.
