...
This is the current task planner. It holds **open** work only, except that SA168 remains checked during its current convergence handoff. Completed tickets, closed findings, review history, and release evidence live in [CHANGELOG.md](../../CHANGELOG.md) and version control; the checked SA168 closeout is removed in the next roadmap cleanup.
...
- [ ] **SA159 — Route repo-source execution through the project interpreter.** `Band A · Tier 2 · W1 · merge #5 · deps: none · blocks SA155, SA134`
