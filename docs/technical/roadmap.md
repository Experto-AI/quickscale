...
───────────────────────────────      ───────────────────────────────────       ───────────────────────────
SA14.1 (no deps — ready)             SA17.5 (no deps — ready)                  SA18.6 (no deps — complete)
SA14.2 (deps: SA14.1)                SA17.6 (no deps — ready)                  SA18.7 (no deps — complete)
SA14.3 (deps: SA14.1)                SA17.7 (deps: SA17.5)                     SA18.8 (no deps — complete)
