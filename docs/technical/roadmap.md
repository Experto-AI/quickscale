...
**Net:** Track 1 carries the merged SA92 blocked checkpoint plus open SA84/SA95 work; no maintainer design decision is pending. Track 2 is clean to continue. Track 3's SA93 is blocked on Track 1 (SA84 + SA95) plus its own deterministic fixes; SA91 on Track 3 can proceed now.
