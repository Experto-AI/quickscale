...
- [ ] Migrate the remaining lower-coupling modules (`notifications`, `social`) one module at a time to the manifest-driven path, deleting one CLI contract file per slice instead of batching them (Finding 1)
