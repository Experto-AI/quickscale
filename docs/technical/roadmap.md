...
> **Closed batches (detail in [CHANGELOG.md](../../CHANGELOG.md)):** SA1–SA5 (2026-07-02), SA6–SA12 (2026-07-03), SA13.1–SA13.4 (2026-07-04), SA14.1–SA14.6 (2026-07-05), SA15.1–SA15.3 (2026-07-04), SA16.1/SA16.2 (2026-07-03), SA17.1–SA17.8 (2026-07-05), SA18.1–SA18.11 (2026-07-04), SA19 (2026-07-05), SA20 (2026-07-06), SA21.1 (2026-07-05), SA22 (2026-07-05), SA23 (2026-07-05), SA24 (2026-07-05), SA25 (2026-07-05), SA26 (2026-07-06), SA27 (2026-07-05), SA28 (2026-07-05), SA29 (2026-07-05), SA30 (2026-07-06), SA31 (2026-07-05), SA32 (2026-07-06), SA33 (2026-07-05), SA34 (2026-07-06), SA35 (2026-07-07), SA36 (2026-07-07), SA37 (2026-07-07), SA39 (2026-07-06), SA40 (2026-07-06), SA43 (2026-07-07), SA45 (2026-07-06). All closed per template rule — detail lives in CHANGELOG.md.
...
SA41 (deps: none)                         SA21.2 (deps: SA21.1 complete, SA36 complete) SA46 (deps: none) — partial, CR-SA46-001 decision resolved (Option B)
...
- [ ] **SA38 — Detect and surface a stranded `STATUS_RESTORING` artifact instead of permanently refusing retry.** `Tier 1 · Track 2 · deps: SA43 (complete) — unblocked, ready to implement`
  ...
  *Decisions (2026-07-07, resolved):* stale threshold **30 minutes** (generous vs. typical `pg_restore` runtimes on this project's scale, avoids false positives on large-DB restores). Staleness warning + guarded reset surface on **both** the `BackupArtifact` admin page (visible without attempting a retry) and the restore-retry flow (today's hard refusal message becomes stale-aware). Reset-to-`FAILED` action lives as a **`services.py` helper** (e.g. `reset_stale_restore(artifact)`) called from both admin surfaces — matching the SA43 "admin is a thin trigger" shape rather than duplicating logic admin-side. Permission boundary: same superuser/staff gate as the existing restore-trigger views (no new permission class needed).
