...
| `django_apps:` was parsed by `manifest/loader.py` and read by no production code path; the declaration gate now enforces app projections | **SA167c** — v88, merge #21; A/B accepted, Phase-C product delta retained in `v88`, C acceptance and D-F pending |
