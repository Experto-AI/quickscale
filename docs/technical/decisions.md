...
| `django_apps:` was parsed by `manifest/loader.py` and read by no production code path; the declaration gate now enforces app projections | **SA167c** — v88, merge #21; retained product object `91fd3bb6e6b638735361b511c1515cddccce5d15`; A-D accepted, E/F pending |
