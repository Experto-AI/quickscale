...
5. **Forward guardrail added:** Unit test (`test_sa90_msq_migration_squash_guardrail.py`) asserts that no module migration contains cross-table org-id DML (`UPDATE ... SET organization_id` referencing another table), so the eliminated class cannot silently return.
...
- No SA90-MSQ blocker remains except mandatory independent review and merge. SA84/SA86 remain open as separate fixtures-only work.
...
**Related docs:** [roadmap.md §SA90-MSQ](./roadmap.md) | [CHANGELOG.md §SA90-MSQ](../../CHANGELOG.md)
