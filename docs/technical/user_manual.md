...
2. **Module selection**: Select optional modules to include. On the main branch and in the current v0.79.0 release, implemented first-party modules include auth, backups, blog, crm, forms, listings, notifications, social, and storage.
