...
- ✅ Theme system: `quickscale plan myproject --theme <name>` + `quickscale apply`
...
- Working Django project in 30 seconds
 - Choice of frontend theme: `quickscale plan myapp --theme <showcase_html|showcase_htmx|showcase_react>` + `quickscale apply`
...
├── pyproject.toml           # (user-added, not generated by quickscale plan/apply)
├── manage.py
