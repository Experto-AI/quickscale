...
| **Gate implementations behave as specified** | 15 retained `scripts/test_*.py` suites; registered `check-gate-suites` gate | **Gated, cache/coverage-disabled** | **closed; 1,224 collected and passed with 2 warnings** |
...
1,224 collected and passed tests with two warnings, and a cache/coverage-disabled
