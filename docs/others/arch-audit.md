...
| Installed artifacts perform their supported lifecycle | Permanent installed-wheel `plan → apply → up` E2E over all modules, accepted under ordered serial and concurrent campaigns | Structural and gated |
