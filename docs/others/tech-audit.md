...
>
> **Update (2026-07-13, SA80.3b/SA87 reconciliation):** SA80.3b rerun completed — 0 missing-`pg_dump`/`pg_restore` failures remain (retained-role: 298 passed/1 failed/2 skipped; default-user: 299 passed/2 skipped). SA80.3/SA80.3b is fully resolved — no longer an open gate failure. The 1 retained-role failure is a pre-existing test-isolation mismatch tracked as **SA87** (backups retained-role assertion, Track 3) in roadmap.md — it blocks the integration gate at the backups stage independently of the other open findings. The current open restricted-role findings keeping the integration gate red are **SA83** (Track 1 blog), **SA84** (Track 1 CRM), **SA85** (Track 2 forms), **SA86** (Track 2 listings), and **SA87** (Track 3 backups). SA81 (per-module lockfiles, no deps) is unrelated cleanup and does not affect the gate. SA80.3b evidence retained: retained-role run 298 passed/1 failed/2 skipped, default-user run 299 passed/2 skipped, zero missing-tool failures in both.
