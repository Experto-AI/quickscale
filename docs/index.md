...
- **Technical**
  ...
  - [v88 Ticket Context](technical/v88_ticket_context.md) - Current v88 ledger: eight open v88 ticket entries across eight open merge positions, lanes W1 3 · W2 3 · W3 2; SA170/TA70, SA167c (EV-7), and SA166 are archived after accepted closeouts; SA164 now heads W2 with `deps: none`, and SA165 heads W1 with `deps: none` as an integrated retained partial with SA165-R1 still tracked and one replacement release verdict authorized as EV-8; no maintainer decision is open
