...
- [2. Documentation Standards](#2-documentation-standards)
  - [2.1. Code Documentation](#21-code-documentation)
    - [2.1.1. Focus on explaining **why** rather than what](#211-focus-on-explaining-why-rather-than-what)
    - [2.1.2. Use single-line comments for major code sections](#212-use-single-line-comments-for-major-code-sections)
    - [2.1.3. Use single-line docstrings for functions and classes](#213-use-single-line-docstrings-for-functions-and-classes)
    - [2.1.4. Document only the functionality (not arguments or returns)](#214-document-only-the-functionality-not-arguments-or-returns)
    - [2.1.5. Follow this docstring format](#215-follow-this-docstring-format)
- [3. Clean Code Principles](#3-clean-code-principles)
  - [3.1. General Principles](#31-general-principles)
  - [3.2. SOLID Principles for AI Assistants](#32-solid-principles-for-ai-assistants)
    - [3.2.1. Single Responsibility (SRP)](#321-single-responsibility-srp)
    - [3.2.2. Open/Closed (OCP)](#322-openclosed-ocp)
    - [3.2.3. Liskov Substitution (LSP)](#323-liskov-substitution-lsp)
    - [3.2.4. Interface Segregation (ISP)](#324-interface-segregation-isp)
    - [3.2.5. Dependency Inversion (DIP)](#325-dependency-inversion-dip)
  - [3.3. DRY (Don't Repeat Yourself)](#33-dry-dont-repeat-yourself)
    - [3.3.1. Use Existing Functionality](#331-use-existing-functionality)
    - [3.3.2. Extract Common Patterns](#332-extract-common-patterns)
  - [3.4. KISS (Keep It Simple, Stupid)](#34-kiss-keep-it-simple-stupid)
    - [3.4.1. Prioritize Readability](#341-prioritize-readability)
    - [3.4.2. Minimize Function Complexity](#342-minimize-function-complexity)
    - [3.4.3. Simplify Control Flow](#343-simplify-control-flow)
    - [3.4.4. Use Appropriate Data Structures](#344-use-appropriate-data-structures)
    - [3.4.5. Minimize Dependencies](#345-minimize-dependencies)
    - [3.4.6. Avoid Premature Optimization](#346-avoid-premature-optimization)
  - [3.5. Avoid Presumptions and Silent Fallbacks](#35-avoid-presumptions-and-silent-fallbacks)
    - [3.5.1. Configuration and Settings](#351-configuration-and-settings)
    - [3.5.2. Input Validation](#352-input-validation)
    - [3.5.3. Error Handling](#353-error-handling)
  - [3.6. Balancing Abstraction and Optimization](#36-balancing-abstraction-and-optimization)
  - [3.7. Debugging and Root Cause Analysis](#37-debugging-and-root-cause-analysis)
  - [3.8. Technical Stack Adherence](#38-technical-stack-adherence)
  - [3.9. Architecture Adherence](#39-architecture-adherence)
- [4. Python Coding Standards](#4-python-coding-standards)
  - [4.1. Code Style](#41-code-style)
    - [4.1.1. Naming Conventions](#411-naming-conventions)
    - [4.1.2. Type Hints](#412-type-hints)
    - [4.1.3. String Formatting](#413-string-formatting)
    - [4.1.4. Imports](#414-imports)
  - [4.2. Code Organization](#42-code-organization)
    - [4.2.1. Function Design](#421-function-design)
    - [4.2.2. File Structure](#422-file-structure)
    - [4.2.3. Error Handling](#423-error-handling)
    - [4.2.4. Comments and Docstrings](#424-comments-and-docstrings)
    - [4.2.5. Logging](#425-logging)
    - [4.2.6. Efficient Code Patterns](#426-efficient-code-patterns)
    - [4.2.7. Performance Considerations](#427-performance-considerations)
- [5. Testing](#5-testing)
  - [5.1. Implementation-First Testing Approach](#51-implementation-first-testing-approach)
    - [5.1.1. Write Implementation First](#511-write-implementation-first)
    - [5.1.2. Test Organization](#512-test-organization)
    - [5.1.3. Effective Testing](#513-effective-testing)
    - [5.1.4. Mock Dependencies](#514-mock-dependencies)
    - [5.1.5. Test Clarity](#515-test-clarity)
    - [5.1.6. Test Data Management](#516-test-data-management)
    - [5.1.7. Test Parameterization](#517-test-parameterization)
    - [5.1.8. Comprehensive Test Coverage](#518-comprehensive-test-coverage)
- [6. Development Workflow](#6-development-workflow)
  - [6.1. Branching Strategy](#61-branching-strategy)
  - [6.2. Adding New Features](#62-adding-new-features)
    - [6.2.1. Plan Before Coding](#621-plan-before-coding)
    - [6.2.2. Follow Project Architecture](#622-follow-project-architecture)
    - [6.2.3. Write Clean, Testable Code](#623-write-clean-testable-code)
    - [6.2.4. Include Proper Documentation](#624-include-proper-documentation)
  - [6.3. Bug Fixing](#63-bug-fixing)
    - [6.3.1. Understand the Root Cause](#631-understand-the-root-cause)
    - [6.3.2. Minimize Code Changes](#632-minimize-code-changes)
    - [6.3.3. Add Regression Tests](#633-add-regression-tests)
    - [6.3.4. Document the Fix](#634-document-the-fix)
- [7. Task Focus](#7-task-focus)
  - [7.1. Maintaining Task Focus](#71-maintaining-task-focus)
    - [7.1.1. Scope Confinement](#711-scope-confinement)
    - [7.1.2. Incremental Changes](#712-incremental-changes)
    - [7.1.3. Preserving Interfaces](#713-preserving-interfaces)
    - [7.1.4. Code Style Consistency](#714-code-style-consistency)
    - [7.1.5. Targeted Bug Fixes](#715-targeted-bug-fixes)
- [8. Focused AI Assistance](#8-focused-ai-assistance)
  - [8.1. Core Rules for Focused AI Solutions](#81-core-rules-for-focused-ai-solutions)
    - [8.1.1. Request Exactness](#811-request-exactness)
    - [8.1.2. Scope Limiting](#812-scope-limiting)
    - [8.1.3. Single-Concern Principle](#813-single-concern-principle)
    - [8.1.4. Review Before Applying](#814-review-before-applying)
    - [8.1.5. Scope Adherence Check](#815-scope-adherence-check)
    - [8.1.6. Iterative Correction](#816-iterative-correction)
  - [8.2. Preventing Common Focus Problems](#82-preventing-common-focus-problems)
    - [8.2.1. Feature Creep Prevention](#821-feature-creep-prevention)
    - [8.2.2. Architecture Preservation](#822-architecture-preservation)
    - [8.2.3. Interface Stability](#823-interface-stability)
    - [8.2.4. Style Consistency](#824-style-consistency)
