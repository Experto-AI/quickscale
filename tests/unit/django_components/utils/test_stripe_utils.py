...
class StripeManagerTests(DjangoModelTestCase):
    ...
    def test_stripe_manager_initialization_with_valid_config(self, mock_is_feature_enabled, mock_get_env, mock_stripe_client):
    ...
    @patch('stripe_manager.stripe_manager.get_env')
    @patch('stripe_manager.stripe_manager.is_feature_enabled')
    def test_stripe_manager_singleton_behavior(self, mock_is_feature_enabled, mock_get_env, mock_stripe_client):
