...
class TestSettingsValidation(unittest.TestCase):
    ...
    def test_validate_required_vars_missing(self):
        ...
        with patch('tests.quickscale_generator.template_generation.test_settings_validation.get_env', return_value=None):
    ...
    def test_validate_required_vars_partial_missing(self):
        ...
        with patch('tests.quickscale_generator.template_generation.test_settings_validation.get_env', side_effect=mock_get_env):
