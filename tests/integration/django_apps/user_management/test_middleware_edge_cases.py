...
class AccountLockoutMiddlewareEdgeCasesIntegrationTests(DjangoIntegrationTestCase):
...
class AccountLockoutMiddlewarePerformanceIntegrationTests(DjangoIntegrationTestCase):
...
class AccountLockoutMiddlewareIntegrationIntegrationTests(DjangoIntegrationTestCase):
    ...
    def test_middleware_chain_integration(self):
        ...
        # Lock the account (get_or_create to avoid duplication)
