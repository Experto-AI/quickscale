...
class AccountLockoutConcurrencyTestCase(TransactionTestCase):
    ...
    @unittest.skipIf(
        ...
        "SQLite doesn't handle concurrent writes well in test environment"
    )
...
class AccountLockoutErrorHandlingIntegrationTests(DjangoIntegrationTestCase):
...
class AccountLockoutPerformanceIntegrationTests(DjangoIntegrationTestCase):
