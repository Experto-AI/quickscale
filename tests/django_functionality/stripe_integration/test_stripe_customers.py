...
class TestStripeCustomerModel:
    ...
    def test_model_attributes(self):
        ...
        model_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), 'quickscale/project_templates/stripe_manager/models.py')
