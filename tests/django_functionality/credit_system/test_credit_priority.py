...
class Sprint9TemplateStructureTests(unittest.TestCase):
    ...
    def test_subscription_template_has_plan_comparison(self):
        ...
        subscription_path = PROJECT_ROOT / 'quickscale/project_templates/templates/admin_dashboard/subscription.html'
        self.assertTrue(subscription_path.exists(), "Subscription template should exist")
...
class Sprint9ViewsImplementationTests(unittest.TestCase):
    ...
    def test_upgrade_downgrade_logic_exists(self):
        ...
        views_path = PROJECT_ROOT / 'quickscale/project_templates/admin_dashboard/views.py'
        self.assertTrue(views_path.exists(), "Views file should exist")
...
class Sprint9URLsConfigurationTests(unittest.TestCase):
    ...
    def test_urls_configuration_for_plan_management(self):
        ...
        urls_path = PROJECT_ROOT / 'quickscale/project_templates/admin_dashboard/urls.py'
        self.assertTrue(urls_path.exists(), "URLs file should exist")
...
class Sprint9StripeProductModelTests(unittest.TestCase):
    ...
    def test_stripe_product_model_structure(self):
        ...
        models_path = PROJECT_ROOT / 'quickscale/project_templates/stripe_manager/models.py'
        self.assertTrue(models_path.exists(), "Models file should exist")
...
class Sprint9TemplateTagsTests(unittest.TestCase):
    ...
    def test_dashboard_template_tags_exist(self):
        ...
        template_tags_path = PROJECT_ROOT / 'quickscale/project_templates/admin_dashboard/templatetags/dashboard_extras.py'
        self.assertTrue(template_tags_path.exists(), "Template tags file should exist")
...
class Sprint9UpgradeDowngradeCheckoutTests(unittest.TestCase):
    ...
    def test_plan_change_success_template_exists(self):
        ...
        template_path = PROJECT_ROOT / 'quickscale/project_templates/templates/admin_dashboard/plan_change_success.html'
        self.assertTrue(template_path.exists(), "Plan change success template should exist")
    ...
    def test_webhook_handles_plan_changes(self):
        ...
        webhook_path = PROJECT_ROOT / 'quickscale/project_templates/stripe_manager/views.py'
        ...
        credits_models_path = PROJECT_ROOT / 'quickscale/project_templates/credits/models.py'
...
class Sprint9CreditTransferTests(unittest.TestCase):
    ...
    def test_credit_transfer_removes_subscription_credits(self):
        ...
        self.assertIn('credit_type=\'PAYG_PURCHASE\'', credits_content, "Should add as pay-as-you-go credits")
    ...
    def test_webhook_credit_transfer_removes_subscription_credits(self):
        ...
        self.assertIn('credit_type=\'PAYG_PURCHASE\'', credits_content, "Should add as pay-as-you-go credits in common function")
    ...
    def test_credit_transfer_uses_correct_credit_types(self):
        ...
        # Test that the addition uses PAYG_PURCHASE credit type  
        self.assertIn("credit_type='PAYG_PURCHASE'  # Make them pay-as-you-go credits", credits_content,
                      "Should use PAYG_PURCHASE credit type for pay-as-you-go credits")
    ...
    def test_webhook_credit_transfer_uses_correct_credit_types(self):
        ...
        self.assertIn("credit_type='PAYG_PURCHASE'", credits_content, "Common function should use PAYG_PURCHASE credit type for transfers")
