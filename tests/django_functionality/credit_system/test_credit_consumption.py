...
class CreditTransactionTypeTests(unittest.TestCase):
    ...
    def test_credit_type_field_exists(self):
        ...
        # Check for choices - updated to current system
    ...
    def test_credit_type_properties(self):
        ...
        # Check for property methods - updated to current system
        self.assertIn("def is_payg_purchase(self):", models_content,
                     "is_payg_purchase property not found")
        self.assertIn("def is_subscription_consumption(self):", models_content,
                     "is_subscription_consumption property not found")
        self.assertIn("def is_payg_consumption(self):", models_content,
                     "is_payg_consumption property not found")
        self.assertIn("def is_admin_adjustment(self):", models_content,
                     "is_admin_adjustment property not found")
        
        # Check for proper return values - updated to current system
        self.assertIn("return self.credit_type == 'PAYG_PURCHASE'", models_content,
                     "is_payg_purchase implementation not found")
        self.assertIn("return self.credit_type == 'SUBSCRIPTION_CONSUMPTION'", models_content,
                     "is_subscription_consumption implementation not found")
        self.assertIn("return self.credit_type == 'PAYG_CONSUMPTION'", models_content,
                     "is_payg_consumption implementation not found")
...
class CreditAccountMethodTests(unittest.TestCase):
    ...
    def test_consume_credits_method_updated(self):
        ...
        # Check for priority-based consumption using specific credit types
        self.assertIn("credit_type='SUBSCRIPTION_CONSUMPTION'", models_content,
                     "SUBSCRIPTION_CONSUMPTION credit_type not found in consume_credits_with_priority")
        self.assertIn("credit_type='PAYG_CONSUMPTION'", models_content,
                     "PAYG_CONSUMPTION credit_type not found in consume_credits_with_priority")
