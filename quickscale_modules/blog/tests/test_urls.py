"""Tests for blog URLs (single flat URL tree, T1.6)."""
...
class TestBlogUrls:
    ...
    def test_media_api_url(self):
        """Test media upload API URL resolves correctly"""
        url = reverse("quickscale_blog:api_upload_media")
        assert url == "/blog/api/media/"
