...
def render_social_managed_views_module(
    ...
    *,
    ...
    return (
        ...
        "from quickscale_modules_orgs.current_org import set_db_current_org_id\n\n"
        ...
        "        )\n\n"
        "        # Preserve prior ambient context so it can be restored\n"
        "        # after the view runs (CR-T1-9-003).\n"
        "        _prior_org_id = get_current_org_id()\n"
        "        resolved_org_id = (\n"
        ...
        "                set_current_org_id(resolved_org_id)\n"
        "                set_db_current_org_id(resolved_org_id)\n"
        "                payload = build_social_link_tree_payload()\n"
        "        finally:\n"
        "            # Restore prior context — exception-safe.\n"
        "            if _prior_org_id is not None:\n"
        "                set_current_org_id(_prior_org_id)\n"
        "            else:\n"
