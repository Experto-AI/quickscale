...
SA170 status is checked as a current consumer contract below; that check is not a mutation
canary.
...
def _assert_sa170_final_closeout(
    ...
    assert "#27, #28 are **retired and not" in roadmap_text
